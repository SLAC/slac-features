 ...
 */
?>
<div class="panel-display general-two-col reverse article_panel_layout<?php if($content['right_sidebar']) { print ' with-right-sidebar';}?><?php if (strlen($content['left']) > 1900) { print ' with-left';}?><?php print ($content['right']) ? '' : ' full-width'; ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
