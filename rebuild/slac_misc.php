<?php
  ...
  $commands = array(
    ...
    array(
      ...
      'command' => 'drush si slac_misc --db-url=mysql://slac_features:SwHbNJEZ6QRxrlU@localhost/slac_features --account-name=admin --account-pass=618hWVCDmY1n3uf --account-mail=admin@example.com --site-name=SLAC-MISC-' . date(DATE_ATOM) . ' -y'
    ),
    array(
